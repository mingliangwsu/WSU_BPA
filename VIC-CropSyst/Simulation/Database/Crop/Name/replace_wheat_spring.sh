...
sed -i 's/^thermal_time_season_end=.*/thermal_time_season_end=1720/g' $outfilename
...
sed -i 's/^emergence=.*/emergence=60/g' $outfilename
sed -i 's/^peak_LAI=.*/peak_LAI=820/g' $outfilename
sed -i 's/^max_root_depth=.*/max_root_depth/g' $outfilename
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=820/1' $outfilename
sed -i 's/^flowering=.*/flowering=920/g' $outfilename
sed -i 's/^filling=.*/filling=1050/g' $outfilename
sed -i 's/^senescence (begin)=.*/senescence (begin)=1050/g' $outfilename
sed -i 's/^maturity=.*/maturity=1720/g' $outfilename
sed -i 's/^full_senescence=.*/full_senescence=1720/g' $outfilename
...
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=1.5/2' $outfilename
...
sed -i 's/^inducement_temperature=.*/inducement_temperature=3/g' $outfilename
