#!/bin/bash
outfilename=Carrot_OFoot_Generic.crp
...
sed -i 's/^=.*/=Vegetables/g' $outfilename
sed -i 's/^canopy_growth=.*/canopy_growth=canopy_cover_2017/g' $outfilename
sed -i 's/^harvested_part=.*/harvested_part=Root/g' $outfilename
...
sed -i 's/^ET_crop_coef=.*/ET_crop_coef=1.05/g' $outfilename
...
sed -i 's/^thermal_time_season_end=.*/thermal_time_season_end=1500/g' $outfilename
...
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=900/1' $outfilename
sed -i 's/^flowering=.*/flowering=900/g' $outfilename
sed -i 's/^filling=.*/filling=10000/g' $outfilename
sed -i 's/^senescence (begin)=.*/senescence (begin)=1100/g' $outfilename
sed -i 's/^maturity=.*/maturity=10000/g' $outfilename
sed -i 's/^full_senescence=.*/full_senescence=1500/g' $outfilename
...
sed -i 's/^unstressed=.*/unstressed=0.95/g' $outfilename
