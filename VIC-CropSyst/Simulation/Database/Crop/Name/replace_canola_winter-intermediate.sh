#!/bin/bash
outfilename=canola_winter-intermediate.crp
...
sed -i 's/^TUE_at_1pKa_VPD=.*/TUE_at_1pKa_VPD=5.5/g' $outfilename
sed -i 's/^TUE_at_1pKa_VPD_veg=.*/TUE_at_1pKa_VPD_veg=5.5/g' $outfilename
sed -i 's/^RUE_global=.*/RUE_global=1.6/g' $outfilename
sed -i 's/^min_tolerable_temp=.*/min_tolerable_temp=0/g' $outfilename
sed -i 's/^max_tolerable_temp=.*/max_tolerable_temp=30/g' $outfilename
sed -i 's/^low_threshold_limit_temp=.*/low_threshold_limit_temp=10/g' $outfilename
sed -i 's/^high_threshold_limit_temp=.*/high_threshold_limit_temp=20/g' $outfilename
...
sed -i 's/^total_season_end=.*/total_season_end=0.8/g' $outfilename
sed -i 's/^thermal_time_season_end=.*/thermal_time_season_end=2720/g' $outfilename
...
sed -i 's/^emergence=.*/emergence=200/g' $outfilename
sed -i 's/^peak_LAI=.*/peak_LAI=1370/g' $outfilename
sed -i 's/^max_root_depth=.*/max_root_depth/g' $outfilename
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=1370/1' $outfilename
sed -i 's/^flowering=.*/flowering=1470/g' $outfilename
sed -i 's/^filling=.*/filling=1860/g' $outfilename
sed -i 's/^senescence (begin)=.*/senescence (begin)=2000/g' $outfilename
sed -i 's/^maturity=.*/maturity=2720/g' $outfilename
sed -i 's/^full_senescence=.*/full_senescence=2720/g' $outfilename
sed -i 's/^thermal_response=.*/thermal_response=linear/g' $outfilename
sed -i 's/^base_temp=.*/base_temp=0/g' $outfilename
...
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=1.9/2' $outfilename
...
sed -i 's/^inducement_temperature=.*/inducement_temperature=0/g' $outfilename
sed -i 's/^unstressed=.*/unstressed=0.22/g' $outfilename
...
sed -i 's/^alpha=.*/alpha=0.003272/g' $outfilename
sed -i 's/^theta=.*/theta=0.941574/g' $outfilename
sed -i 's/^growth_ratio_asymtotic=.*/growth_ratio_asymtotic=1.2771/g' $outfilename
