...
sed -i 's/^wilt_leaf_water_pot=.*/wilt_leaf_water_pot=-2000/g' $outfilename
sed -i 's/^kc=.*/kc=0.5/g' $outfilename
sed -i 's/^initial=.*/initial=0.05/g' $outfilename
sed -i 's/^maximum=.*/maximum=0.9/g' $outfilename
sed -i 's/^green_season_end=.*/green_season_end=0.05/g' $outfilename
...
sed -i 's/^peak_LAI=.*/peak_LAI=1373/g' $outfilename
sed -i 's/^max_root_depth=.*/max_root_depth/g' $outfilename
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=1373/1' $outfilename
sed -i 's/^flowering=.*/flowering=1473/g' $outfilename
sed -i 's/^filling=.*/filling=1856/g' $outfilename
