...
sed -i 's/^emergence=.*/emergence=120/g' $outfilename
sed -i 's/^peak_LAI=.*/peak_LAI=50/g' $outfilename
sed -i 's/^max_root_depth=.*/max_root_depth/g' $outfilename
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=450/1' $outfilename
sed -i 's/^flowering=.*/flowering=470/g' $outfilename
sed -i 's/^filling=.*/filling=1250/g' $outfilename
sed -i 's/^senescence (begin)=.*/senescence (begin)=1400/g' $outfilename
...
sed -i 's/^deg_day_bud break shill req sat=.*/deg_day_bud break shill req sat=120/g' $outfilename
sed -i 's/^deg day bud break chill req not sat=.*/deg day bud break chill req not sat=140/g' $outfilename
...
sed -i 's/^fract_tot_solids=.*/fract_tot_solids=0.25/g' $outfilename
sed -i 's/^max_fruit_load=.*/max_fruit_load=22000/g' $outfilename
