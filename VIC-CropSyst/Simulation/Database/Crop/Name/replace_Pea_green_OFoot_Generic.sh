#!/bin/bash
outfilename=Pea_green_OFoot_Generic.crp
...
sed -i 's/^TUE_at_1pKa_VPD=.*/TUE_at_1pKa_VPD=4.5/g' $outfilename
sed -i 's/^TUE_at_1pKa_VPD_veg=.*/TUE_at_1pKa_VPD_veg=4.5/g' $outfilename
sed -i 's/^RUE_global=.*/RUE_global=1.5/g' $outfilename
...
sed -i 's/^peak_LAI=.*/peak_LAI=960/g' $outfilename
sed -i 's/^max_root_depth=.*/max_root_depth/g' $outfilename
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=960/1' $outfilename
sed -i 's/^flowering=.*/flowering=960/g' $outfilename
sed -i 's/^filling=.*/filling=1000/g' $outfilename
sed -i 's/^senescence (begin)=.*/senescence (begin)=1050/g' $outfilename
sed -i 's/^maturity=.*/maturity=1500/g' $outfilename
sed -i 's/^full_senescence=.*/full_senescence=1500/g' $outfilename
sed -i 's/^thermal_response=.*/thermal_response=linear/g' $outfilename
sed -i 's/^base_temp=.*/base_temp=4/g' $outfilename
...
sed -i 's/^max_canopy_height=.*/max_canopy_height=0.5/g' $outfilename
