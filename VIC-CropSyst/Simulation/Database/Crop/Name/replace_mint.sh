...
sed -i 's/^maximum=.*/maximum=0.97/g' $outfilename
sed -i 's/^green_season_end=.*/green_season_end=0.97/g' $outfilename
sed -i 's/^total_season_end=.*/total_season_end=0.97/g' $outfilename
...
sed -i 's/^peak_LAI=.*/peak_LAI=1100/g' $outfilename
sed -i 's/^max_root_depth=.*/max_root_depth/g' $outfilename
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=700/1' $outfilename
sed -i 's/^flowering=.*/flowering=2000/g' $outfilename
sed -i 's/^filling=.*/filling=1250/g' $outfilename
sed -i 's/^senescence (begin)=.*/senescence (begin)=1300/g' $outfilename
...
sed -i 's/^max_canopy_height=.*/max_canopy_height=0.8/g' $outfilename
...
sed -i 's/^unstressed=.*/unstressed=1/g' $outfilename
