...
sed -i 's/^maximum=.*/maximum=0.8/g' $outfilename
sed -i 's/^green_season_end=.*/green_season_end=0.3/g' $outfilename
...
sed -i 's/^emergence=.*/emergence=24/g' $outfilename
sed -i 's/^peak_LAI=.*/peak_LAI=630/g' $outfilename
sed -i 's/^max_root_depth=.*/max_root_depth/g' $outfilename
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=600/1' $outfilename
sed -i 's/^flowering=.*/flowering=680/g' $outfilename
sed -i 's/^filling=.*/filling=1115/g' $outfilename
sed -i 's/^senescence (begin)=.*/senescence (begin)=720/g' $outfilename
...
sed -i 's/^unstressed=.*/unstressed=0.45/g' $outfilename
