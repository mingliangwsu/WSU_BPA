...
sed -i 's/^thermal_time_season_end=.*/thermal_time_season_end=2140/g' $outfilename
...
sed -i 's/^emergence=.*/emergence=70/g' $outfilename
sed -i 's/^peak_LAI=.*/peak_LAI=1170/g' $outfilename
sed -i 's/^max_root_depth=.*/max_root_depth/g' $outfilename
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=1170/1' $outfilename
sed -i 's/^flowering=.*/flowering=1250/g' $outfilename
sed -i 's/^filling=.*/filling=1420/g' $outfilename
sed -i 's/^senescence (begin)=.*/senescence (begin)=1420/g' $outfilename
sed -i 's/^maturity=.*/maturity=2140/g' $outfilename
sed -i 's/^full_senescence=.*/full_senescence=2140/g' $outfilename
...
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=1.8/2' $outfilename
...
sed -i 's/^max_canopy_height=.*/max_canopy_height=1/g' $outfilename
...
sed -i 's/^unstressed=.*/unstressed=0.48/g' $outfilename
sed -i 's/^translocation_max=.*/translocation_max=0.35/g' $outfilename
