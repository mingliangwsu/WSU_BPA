#!/bin/bash
outfilename=wheat_spring-intermediate.crp
...
sed -i 's/^max_root_depth=.*/max_root_depth=820/1' $outfilename
...
sed -i 's/^max_root_depth=.*/max_root_depth=1.5/2' $outfilename
