...
sed -i 's/^harvested_part=.*/harvested_part=seed/g' $outfilename
...
sed -i 's/^TUE_at_1pKa_VPD=.*/TUE_at_1pKa_VPD=3.8/g' $outfilename
sed -i 's/^TUE_at_1pKa_VPD_veg=.*/TUE_at_1pKa_VPD_veg=3.8/g' $outfilename
...
sed -i 's/^max_water_uptake=.*/max_water_uptake=13/g' $outfilename
...
sed -i 's/^maximum=.*/maximum=0.7/g' $outfilename
...
sed -i 's/^peak_LAI=.*/peak_LAI=850/g' $outfilename
sed -i 's/^max_root_depth=.*/max_root_depth/g' $outfilename
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=800/1' $outfilename
sed -i 's/^flowering=.*/flowering=950/g' $outfilename
sed -i 's/^filling=.*/filling=1500/g' $outfilename
sed -i 's/^senescence (begin)=.*/senescence (begin)=1000/g' $outfilename
