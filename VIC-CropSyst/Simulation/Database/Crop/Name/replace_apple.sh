...
sed -i 's/^maximum=.*/maximum=0.5/g' $outfilename
sed -i 's/^green_season_end=.*/green_season_end=0.5/g' $outfilename
sed -i 's/^total_season_end=.*/total_season_end=0.5/g' $outfilename
...
sed -i 's/^emergence=.*/emergence=130/g' $outfilename
sed -i 's/^peak_LAI=.*/peak_LAI=70/g' $outfilename
sed -i 's/^max_root_depth=.*/max_root_depth/g' $outfilename
sed -i ':a;N;$!ba;s/max_root_depth/max_root_depth=240/1' $outfilename
sed -i 's/^flowering=.*/flowering=200/g' $outfilename
sed -i 's/^filling=.*/filling=1700/g' $outfilename
...
sed -i 's/^chill requirement=.*/chill requirement=800/g' $outfilename
sed -i 's/^deg_day_bud break shill req sat=.*/deg_day_bud break shill req sat=130/g' $outfilename
sed -i 's/^deg day bud break chill req not sat=.*/deg day bud break chill req not sat=150/g' $outfilename
...
sed -i 's/^max_canopy_height=.*/max_canopy_height=3/g' $outfilename
...
sed -i 's/^fract_tot_solids=.*/fract_tot_solids=0.3/g' $outfilename
sed -i 's/^max_fruit_load=.*/max_fruit_load=39200/g' $outfilename
