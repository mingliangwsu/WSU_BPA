...
if len(sys.argv) == 4:
    ...
    print("Usage:" + sys.argv[0] + "<irrigation:TRUE or FALSE> <VIC_output_dir> <Output_dir>")
    exit()
...
for irrigation in irrigation_list:
    ...
    avg_annual_file_out = generateout_dir + "/" + "avg_allgridcell_annual_irr_" + irrigation + ".txt"
    avg_month_file_out = generateout_dir + "/" + "avg_allgridcell_month_irr_" + irrigation + ".txt"
    annual_file_out = generateout_dir + "/" + "allgridcell_annual_irr_" + irrigation + ".txt"
    month_file_out = generateout_dir + "/" + "allgridcell_month_irr_" + irrigation + ".txt"
    ...
    annual_all.to_csv(annual_file_out, index=False, float_format='%.3f')
    month_all.to_csv(month_file_out, index=False, float_format='%.3f')


os.remove("tempvic.txt")
